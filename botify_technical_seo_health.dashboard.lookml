- dashboard: botify_technical_health_dashboard
  ...
  - name: ''
    type: text
    body_text: <img src="https://cdn2.hubspot.net/hubfs/4835142/Botify-logo-purple-RGB.png"
      alt="Botify Logo" height="103" width="300">
    row: 0
    col: 4
    width: 20
    height: 3
  ...
  - title: Total Revenue & Revenue Per Visit
    ...
    series_colors:
      ...
      export.sum_estimated_revenue_from_organic_providers: "#FFAD00"
    series_labels:
  ...
  - title: Revenue Contribution by Pagetype
    ...
    totals_color: "#808080"
    color_application:
      collection_id: b3939219-d0d3-4434-8f99-4485a35ea4ec
      custom:
        id: fd1446ec-a3d4-f3f6-e5d6-5776ebefdb5b
        label: Custom
        type: discrete
        colors:
        - "#2A1D86"
    ...
    series_types: {}
    series_colors:
      home - export.sum_estimated_revenue_from_organic_providers: "#7e7e7e"
      nav/category - export.sum_estimated_revenue_from_organic_providers: "#D4D4D4"
      other - export.sum_estimated_revenue_from_organic_providers: "#CB89F2"
